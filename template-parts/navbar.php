        ...
        <header class="header_area">
            <nav class="navbar navbar-expand-lg menu_one menu_four">
                <div class="container">
                    <a class="navbar-brand sticky_logo" href="blockquote.html#"><img src="img/logo2.png" srcset="img/logo2x-2.png 2x" alt="logo"><img src="img/logo.png" srcset="img/logo2x.png 2x" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav menu w_menu">
                            <li class="nav-item dropdown submenu mega_menu mega_menu_two">
                                ...
                                <div class="mega_menu_inner">
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <ul class="dropdown-menu scroll mCustomScrollbar _mCS_1">
                                                <div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: 614.4px;" tabindex="0">
                                                    <div id="mCSB_1_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
                                                        <li class="nav-item">
                                                            <a href="home-chat.html" class="item">
                                                                <span class="img">
                                                                    <span class="rebon_tap">New</span>
                                                                    <img src="img/mega-menu-img/home-chat.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Home Chat
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-tracking.html" class="item">
                                                                <span class="img">
                                                                    <span class="rebon_tap">New</span>
                                                                    <img src="img/mega-menu-img/home-track.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Home Tracking
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-event.html" class="item">
                                                                <span class="img">
                                                                    <span class="rebon_tap">New</span>
                                                                    <img src="img/mega-menu-img/home-event.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Home Event
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-security.html" class="item">
                                                                <span class="img">
                                                                    <span class="rebon_tap">New</span>
                                                                    <img src="img/mega-menu-img/home-security.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Home Security
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-split.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home7.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Home Split
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-support.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/support.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Support
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-color.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home-animation.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Scroll Animation
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-erp.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/analytices.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Analytices
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-hosting.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/hosting.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Hosting
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-pos.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/pos.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    POS
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-erp.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/erp.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    ERP
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-prototype-two.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/Prototyping_Tool.jpg" alt="Prototyping Tool" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Prototyping Tool
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-payment-processing.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home16.jpg" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Payment Processing
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-mail.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home9.jpg" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Email Client
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-startup.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home15.jpg" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Startup
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-saas.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home17.jpg" alt="Classic Saas" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Classic Saas
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-software-dark.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home13.jpg" alt="Software (Dark)" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Software (Dark)
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-app-showcase.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home14.jpg" alt="App Showcase" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    App Showcase
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-digital-marketing.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home11.jpg" alt="Digital Marketing" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Digital Marketing
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-cloud.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home12.jpg" alt="Cloud Based Saas" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Cloud Based Saas
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-hr-management.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home4.jpg" alt="HR Management" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    HR Management
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-marketing-two.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home3.jpg" alt="CRM Software" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    CRM Software
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-payment-style2.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home1.jpg" alt="Accounts &amp; Billing" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Accounts &amp; Billing
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-digital-marketing-two.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home5.jpg" alt="Digital Agency" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Digital Agency
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-project-management.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home8.jpg" alt="Project Management" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Project Management
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-saas-two.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/saas2-slider.png" alt="Saas 02 (Slider)" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Saas 02 (Slider)
                                                                </span>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="home-company.html" class="item">
                                                                <span class="img">
                                                                    <img src="img/mega-menu-img/home2.jpg" alt="home2" class="mCS_img_loaded">
                                                                </span>
                                                                <span class="text">
                                                                    Company
                                                                </span>
                                                    ...
                                                    <div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-light mCSB_scrollTools_vertical" style="display: block;">
                                                        <div class="mCSB_draggerContainer">
                                                            <div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 30px; display: block; height: 186px; max-height: 604.4px; top: 0px;">
                            ...
                            <li class="nav-item dropdown submenu<?=iiF(paginaAtual($_SERVER["SCRIPT_NAME"]), 'sobre-nos', ' active', '')?>">
                                <a class="nav-link dropdown-toggle" href="header-dark.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Sobre Nós
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="blog-masonry-two.html" class="nav-link">Blog Masonry
                                            Two</a></li>
                                    <li class="nav-item"><a href="blog-masonry-sidebar.html" class="nav-link">Blog Masonry
                                            Sidebar</a></li>
                                    ...
                                    <li class="nav-item"><a href="blog-single-two.html" class="nav-link">Blog Single Two</a>
                                    </li>
                                </ul>
                            </li>
